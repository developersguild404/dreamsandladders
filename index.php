    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Welcome <?php echo $_SESSION["user_nickname"]?></h1>
						<!--
                        <ol class="breadcrumb">
                            <li class="active">
					...
					<div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-fw fa-star"></i> How are you <?php echo "$_SESSION[user_nickname]?"; ?></h3>
                            </div>
                            <div class="panel-body">
								...
								<div class="col-sm-12 col-lg-12">
									<div class="panel panel-primary">
										<div class="panel-heading">
											<h3 class="panel-title"> What would be your career in the next 10 years?</h3>
										</div>
										<div class="panel-body">
											<form action="call_functions_jquery_ajax/insert_dream.php" method="post" enctype="multipart/form-data">
												  <div class="form-group">
													
													<textarea class="form-control " rows="3" name="dreamCaption" placeholder="We will put the questions here"></textarea>
													<br />
													<input type="file" name="file" id="file"><br />
													<button  type="submit" class="btn btn-primary" name="insertDream">submit</button>
												</div>
											</form>
										</div>
									</div>
								...
								<div class="col-sm-12 col-lg-12">
									<div class="panel panel-green">
										<div class="panel-heading">
											<h3 class="panel-title"> What is your dream house would be like?</h3>
										</div>
										<div class="panel-body">
											<form action="call_functions_jquery_ajax/insert_dream.php" method="post" enctype="multipart/form-data">
												  <div class="form-group">
													
													<textarea class="form-control " rows="3" name="ladCaption" placeholder="We will put the questions here"></textarea>
													<br />
													<input type="file" name="file" id="file"><br />
													<button  type="submit" class="btn btn-success" name="insertDream">submit</button>
												</div>
											</form>
										</div>
									</div>
								...
								<div class="col-sm-12 col-lg-12">
									<div class="panel panel-yellow">
										<div class="panel-heading">
											<h3 class="panel-title"> We will put the questions here and it will random in every login</h3>
										</div>
										<div class="panel-body">
											<form action="call_functions_jquery_ajax/insert_dream.php" method="post" enctype="multipart/form-data">
												  <div class="form-group">
													...
													<br />
													<input type="file" name="file" id="file"><br />
													<button  type="submit" class="btn btn-warning" name="insertDream">submit</button>
												</div>
											</form>
										</div>
									</div>
