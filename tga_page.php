                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <i class="fa fa-fw fa-book"></i>  The Great Adviser 
                        </h1>
						<!--
                        <ol class="breadcrumb">
                            <li class="active">
				...
				<div class="row">
								...
								<div class="col-lg-3">
									<div class="panel panel-primary">
										<div class="panel-heading">
											<h3 class="panel-title">Life Advice</h3>
										</div>
										<div class="panel-body">
											
											 <div class="form-group">
												<p class="panel panel-body">"Keep your face always toward the sunshine - and shadows will fall behind you"</p>
												<strong>Walt Whitman</strong><br />
												<button type="submit" class="btn btn-primary">Read More Advice</button>
											</div>
								...
								<div class="col-lg-3">
									<div class="panel panel-yellow">
										<div class="panel-heading">
											<h3 class="panel-title">Academic Advice</h3>
										</div>
										<div class="panel-body">
											 <div class="form-group">
												<p class="panel panel-body">"Learn to manage your time and energy, in that way you can more time to study"</p>
								...
								<div class="col-lg-3">
									<div class="panel panel-green">
										<div class="panel-heading">
											<h3 class="panel-title">Financial Advice</h3>
										</div>
										<div class="panel-body">
											 <div class="form-group">
												<p class="panel panel-body">"Money does not buy you anything, but it is obviously a necessity"</p>
												<strong>Anonymous</strong><br />
												<button type="submit" class="btn btn-primary">Read More Advice</button>
											</div>
										</div>
								...
								<div class="col-lg-3">
									<div class="panel panel-red">
										<div class="panel-heading">
											<h3 class="panel-title">Love Advice</h3>
										</div>
										<div class="panel-body">
											 <div class="form-group">
												<p class="panel panel-body">"Don't chase people the right one's will stay."</p>
												<strong>Anonymous</strong><br />
												<button type="submit" class="btn btn-primary">Read More Advice</button>
											</div>
										</div>
