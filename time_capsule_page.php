            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <i class="fa fa-fw fa-sign-in"></i>  Time Capsule
                        </h1>
						<!--
                        <ol class="breadcrumb">
                            <li class="active">
				...
				<div class="row">
					<div class="col-lg-8">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-pencil"></i> Compose Message</h3>
                            </div>
                            <div class="panel-body">
								
								<div class="form-group">
									<form action="call_functions_jquery_ajax/insert_time_capsule.php" method="POST"><!-- insert ladder form START -->
										<p>Dear future <?php echo "<strong>$_SESSION[user_nickname]</strong>"; ?>,</p>
										
										<textarea name="tc_caption" class="form-control " rows="3" placeholder="Hi, how are you? Have you become what we have always wanted. How is our career? Have you bought our dream house? Do you find your soulmate?I know you miss me and I am excited for you. Good luck!"></textarea><br />
										<p>Truly yours,<br />
										<strong>Current Me</strong>
										</p>
					...
					<div class="col-lg-4">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-calendar"></i> Set your Time Capsule</h3>
                            </div>
                            <div class="panel-body">
								...
								<div class="form-group">
									 <div class="form-group">
										...
										<select class="form-control" name="tc_date_to_show">
											<option value="5">5 years from now</option>
											<option value="10">10 years from now</option>
											<option value="20">20 years from now</option>
											<option value="30">30 years from now</option>
										</select>
									</div>
									<button type="submit" class="btn btn-primary" name="insertTimeCapsule">Seal this Capsule</button>
									</form><!-- insert ladder form END -->
								</div>
                            </div>
                        </div>
                    </div>
